						...
						<Form>
							<div className="mb-4">
								...
								<Field
									...
									id="title"
									name="title"
									className="border-transparent bg-gray-50 border border-gray-300 text-white-500 text-sm rounded-lg focus:ring-[#E73B7B] focus:border-[#E73B7B] block w-full p-2.5"
								/>
								<ErrorMessage
									name="title"
									component="div"
							...
							<div className="flex justify-center">
								<button
									...
									className={`text-white flex mt-7 mb-4 w-full text-center lg:flex bg-[#663be7] hover:bg-[#bc662d] focus:ring-4 justify-center focus:outline-none font-light max-md:rounded-2xl md:rounded-3xl md:px-5 md:py-2 py-1 px-4`}
								>
